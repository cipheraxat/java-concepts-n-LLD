...
public class LambdaFunctionalDemo {
    ...
    static void methodReferences() {
        ...
        // BiFunction constructor reference
        BiFunction<String, Integer, String[]> arrayFactory = String[]::new;  // creates String[n]?
        // Actually: IntFunction<String[]> factory = String[]::new;
    ...
    static void capturingDemo() {
        ...
        // Lambda does NOT capture 'this' — it uses the enclosing class's 'this'
        // Anonymous class captures containing instance:
        Runnable lambda = () -> System.out.println("Lambda 'this': " + this.getClass().getName());
